    ...
    <section>
        ...
        <div class="sec1">
            <div class="container">
                ...
                <div class="social">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/14179583611530077750-128.png" Height="60px" Width="59px" />
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/images/4975046521605656747-128.png" Height="60px" style="margin-left: 22px" Width="65px" />
                </div>
                       </div>
        </div>
    </form>
